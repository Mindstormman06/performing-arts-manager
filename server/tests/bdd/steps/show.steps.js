...
When('they attempt to create a new show titled {string} for the organization', async function (showTitle) {
...
Then('the new show should be saved successfully', function () {
    ...
    assert.ok(responseData.id, "Expected the database to return the newly created show ID");
});