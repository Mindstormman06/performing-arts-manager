...
import CreateOrgEventModal from "../components/CreateOrgEventModal.jsx";
import ManageOrgEventModal from "../components/ManageOrgEventModal.jsx";
...
export default function OrgSchedule() {
	...
	const fetchScheduleData = useCallback(async () => {
		try {
			...
			console.error("Failed to fetch organization schedule data", err);
		} finally {
			setIsLoading(false);
		}
	}, [orgId]);
