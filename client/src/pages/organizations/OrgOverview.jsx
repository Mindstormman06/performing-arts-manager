...
import EditOrgModal from "../../components/modals/Organizations/EditOrgModal.jsx";
import FullMembersModal from "../../components/modals/Organizations/FullMembersModal.jsx";
import InviteMemberModal from "../../components/modals/Organizations/InviteMemberModal.jsx";
import RoleModal from "../../components/modals/Organizations/OrgRoleModal.jsx";
import CreateShowModal from "../../components/modals/Shows/CreateShowModal.jsx";
import {
	deleteOrganization,
	getOrganization,
...
import OrgHeader from "../../components/ui/organizations/OrgHeader.jsx";
import ShowCard from "../../components/ui/shows/ShowCard.jsx";
...
export default function OrgOverview() {
	...
	const handleDeleteOrg = async () => {
		const firstConfirm = window.confirm("Are you sure you want to delete this organizations?");
		if (firstConfirm) {
			...
			if (secondConfirm) {
				try {
					...
					alert(err.response?.data?.message || "Failed to delete organizations");
				}
			}
		}
	};
