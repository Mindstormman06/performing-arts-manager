...
import { getShowInventory, getDepartments, getShowUsers, verifyToken, removeShowItem } from "../services/api";
import DashboardSection from "../components/ui/DashboardSection";
import ManageShowInventoryModal from "../components/ManageShowInventoryModal";
                ...
                <div className="overflow-x-auto rounded-lg border border-gray-200 bg-white shadow-sm">
                    <table className="w-full text-left text-sm text-gray-600">
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            )) : <tr><td colSpan="4" className="px-6 py-8 text-center italic text-gray-500">No inventory items assigned to this show.</td></tr>}
                        </tbody>
                    </table>
                </div>
            </DashboardSection>
