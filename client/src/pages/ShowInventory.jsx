							...
							{filteredItems.length > 0 ? (
								filteredItems.map((item) => (
									...
									>
										...
										<td className="px-6 py-4">
											{item.is_global ? (
												<span className="rounded bg-purple-50 px-2 py-1 font-medium text-purple-600 text-xs">
													Global Stock
												</span>
											) : (
												<span className="rounded bg-amber-50 px-2 py-1 font-medium text-amber-600 text-xs">
													Custom Show Item
												</span>
											)}
										</td>
