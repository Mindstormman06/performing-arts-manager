...
function Landing({ token }) {
	return (
		<section
			...
			style={{ backgroundImage: "url('/images/backdrop.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}
		>
			<div className="absolute inset-0 bg-black/40" aria-hidden="true" />

			<div className="relative z-10 w-screen border-y border-white/15 bg-black/55 py-12 backdrop-blur-sm sm:py-16">
				<div className="mx-auto max-w-4xl px-6 text-center text-white sm:px-10">
					<p className="mb-4 font-semibold tracking-[0.25em] text-blue-200 uppercase">
					...
					<p className="mx-auto mt-6 max-w-2xl text-base text-gray-200 sm:text-lg">
						Performing Arts Manager keeps your organization, shows, members, and inventory all in one
						place so your team can stay focused on the performance.
					</p>
