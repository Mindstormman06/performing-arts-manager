    ...
    return (
        <li>
            <button
                ...
                onClick={onClick}
            >
                <div className={`mr-3 flex h-8 w-8 shrink-0 items-center justify-center rounded-full font-bold text-sm ${
                    isPending ? "bg-gray-100 text-gray-400" : "bg-indigo-100 text-indigo-700"
                }`}>
                    {initials}
                </div>
